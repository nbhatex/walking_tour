...
//  Walking Tour
//
//  Created by Narasimha Bhat on 22/05/16.
...
class Colors {
    ...
    static let colors = [UIColor(colorLiteralRed: 140/255, green: 196/255, blue: 82/255, alpha: 1),
    ...
    class func  getColor(text:String) -> UIColor {
        let sclars = text.unicodeScalars
        let alphabetIdx = sclars[sclars.startIndex].value - 65
        return colors[Int(alphabetIdx % 18)]
    }
}